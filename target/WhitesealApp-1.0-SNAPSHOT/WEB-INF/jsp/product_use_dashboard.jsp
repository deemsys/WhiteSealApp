...
<div id="right_content">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		   ...
		   <td >
			...
			<td>
				<div style="margin-left:30px;"><img src="<c:url value="/resources/images/prod_use - Copy1.png" />" alt="Product Use" style="margin-top:20px;"/></div> 
			</td>
			
			<td>
				<div><img src="<c:url value="/resources/images/prod_use - Copy2.png" />" alt="Product Use" style="margin-top:20px;"/></div> 
			</td>
			
			<td>	
			<div><img src="<c:url value="/resources/images/prod_use - Copy - Copy.png" />" alt="Product Use" style="margin-top:20px;"/></div> 
